...
# .info() : 열에 대한 요약 정보 확인
# 8807 rows(원본 데이터 행 개수) - 17 rows(결측치 행) = 8790 rows(결측치 제거된 행 개수)
netflix.info()
...
# 쉼표로 country 열의 값에 explode( ) 함수를 적용하여 개별 행으로 분리
...
plt.suptitle('Keywards in the description of Movies and TV shows',
             fontweight='bold', fontfamily='serif', fontsize=15)
