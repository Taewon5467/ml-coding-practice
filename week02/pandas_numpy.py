...
print(sample_df.drop(['var_1','var2'], axis=1))
...
more2015_tv = netflix[(netflix['release_year'] > 2015) & (netflix['type'] == 'TV_Show')]
...
data = {
    ...
    'has_image': [True, False, True, True, False, False, True, False, True, True]
}